...
class Caption_Generator():
    ...
    def build_generator(self, maxlen):
        ...
        print "self.lstm.state_size:", self.lstm.state_size
        print "self.lstm.state_size.c:", self.lstm.state_size.c
        print "self.lstm.state_size.h:", self.lstm.state_size.h

        # temp = tf.contrib.rnn.BasicLSTMCell(self.lstm.state_size)
        state = tf.zeros([1, self.lstm.state_size])

        print "after creating state variable"
...
test_tf('acoustic-guitar-player.jpg')
